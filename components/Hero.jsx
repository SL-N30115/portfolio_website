            ...
            <div className="container mx-auto">
                <div className="flex justify-between gap-x-8">
                    ...
                    <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
                        ...
                        <h1 className="h1 mb-4">Hello, my name is Steven Lai</h1>
                        ...
                        <div className="flex flex-col gap-y-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12">
                            ...
                            <Link rel="noopener noreferrer" target="_blank" href='/Steven_Lai_Resume_hk.pdf'>
                    ...
                    <div className="hidden xl:flex relative">
                        {/* badge */}
                        <Badge containerStyles='absolute top-[24%] -left-[7rem]' icon={<RiBriefcase4Fill />} endCountNum={4} badgeText='Years Of Experience' />
                        <div className="bg-hero_shape2_light 
                        dark:bg-hero_shape2_dark w-[500px] h-[500px]
                        bg-no-repeat absolute -top-1 -right-2"></div>
                        <DevImg containerStyles='bg-hero_shape w-[510px] h-[462px] bg-no-repeat relative bg-bottom' imgSrc='/hero/developer_3.png' />
                    </div>
                    {/* icons */}
